...
export const fontSizes: RootTypographyMap = {
  ...
  'head-2xl': 'env(--typography-font-size-head-2xl, 2.5rem)', // 40px
  'head-3xl': 'env(--typography-font-size-head-3xl, 2.25rem)', // 36px
  'head-4xl': 'env(--typogryaphy-font-size-head-4xl, 2rem)', // 32px
  'head-5xl': 'env(--typography-font-size-head-5xl, 1.75rem)', // 28px
  'head-6xl': 'env(--typography-font-size-head-6xl, 1.5rem)', // 24px
  'head-xl': 'env(--typography-font-size-head-xl, 3rem)', // 48px
...
export const lineHeights: RootTypographyMap = {
  ...
  'head-2xl': 'env(--typography-line-height-head-2xl, 3rem)', // 48px
  'head-3xl': 'env(--typography-line-height-head-3xl, 2.75rem)', // 44px
  'head-4xl': 'env(--typography-line-height-head-4xl, 2.5rem)', // 40px
  'head-5xl': 'env(--typography-line-height-head-5xl, 2.125rem)', // 34px
  'head-6xl': 'env(--typography-line-height-head-6xl, 1.875rem)', // 30px
  'head-xl': 'env(--typography-line-height-head-xl, 3.5rem)', // 56px
